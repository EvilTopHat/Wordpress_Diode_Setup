...
sed 's/AUTH_KEY/begin_insert_here/' /srv/www/wordpress/wp-config.php
sed 's/SECURE_AUTH_KEY//' /srv/www/wordpress/wp-config.php
sed 's/LOGGED_IN_KEY//' /srv/www/wordpress/wp-config.php
sed 's/NONCE_KEY//' /srv/www/wordpress/wp-config.php
sed 's/AUTH_SALT//' /srv/www/wordpress/wp-config.php
sed 's/SECURE_AUTH_SALT//' /srv/www/wordpress/wp-config.php
sed 's/LOGGED_IN_SALT//' /srv/www/wordpress/wp-config.php
sed 's/NONCE_SALT//' /srv/www/wordpress/wp-config.php
