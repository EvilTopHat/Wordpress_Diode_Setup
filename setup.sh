...
#finish installation
wp core install --allow-root --path="/srv/www/wordpress" --title="wordpress diode" --url="https://${diode_address}.diode.link" --admin_email="admin@localhost.com"  --admin_password="$wordpress_admin_password" --admin_user="admin"
